...
.message-box {
  ...
  .message {
            background-color: #7d2ae8; /* Light red background color */
            padding: 10px;
            border: 1px solid #f5c6cb; /* Border color for light red background */
    ...
    z-index: 1000;
    overflow: hidden; 
    background: linear-gradient(45deg, #fff 30%, #7d2ae8 30%);
    padding: px 0;
    color: #5b13b9; 
}
    ...
    <a href="#"><img src="../images/ExamLogo.png" alt="Your Logo"></a>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="login.php">Examiner Login</a>
                <a href="../examineee/login.php">Examinee Login</a>
            </div>
        </div>
        <!-- End Dropdown -->
    </div>
        ...
        <div class="form-content">
          ...
          <?php
                    if (!empty($loginMessage)) {
                        echo '<p class="message">' . $loginMessage . '</p>';
                    }
                    ?>
