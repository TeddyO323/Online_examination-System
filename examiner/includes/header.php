...
<?php 
  ...
  // Fetch the examiner name from the database
  $examinerNumber = $_SESSION['examiner_number'];
  $sql = "SELECT examiner_name FROM examiner_tbl WHERE examiner_number = '$examinerNumber'"; // Modify the query based on your specific table structure
...
<div class="btn-group">
    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
        Welcome <?php echo $examinerName; ?>
        <i class="fa fa-angle-down ml-2 opacity-8"></i>
    </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                        <button type="button" tabindex="0" class="dropdown-item">
    <a href="index.php?page=examiner-account" style="text-decoration: none; color: #333;">Profile</a>
</button>
