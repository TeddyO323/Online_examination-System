<?php
    // Define $selCourse before using it
    $selCourse = ['totCourse' => 0]; // Initializing with a default value
    // ... rest of the code ...

    // Accessing the variable later in the code
    if (isset($selCourse['totCourse'])) {
        echo $totalCourse = $selCourse['totCourse'];
    } else {
        echo "0"; // Providing an alternative value if the key 'totCourse' is not set
    }
?>
    ...
    <div class="card mb-3 widget-content bg-arielle-smile">
        <div class="widget-content-wrapper text-white">
            ...
            <div class="widget-content-right">
                <div class="widget-numbers text-white">
                    <?php
                    // Define $selExam before using it
                    $selExam = ['totExam' => 0]; // Provide a default value
                    if (isset($selExam['totExam'])) {
                        echo $totalExam = $selExam['totExam'];
                    } else {
                        echo "0"; // Or provide an alternative value
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="main-card mb-3 card">
                ...
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                        ...
                        <tbody>
                            <?php 
                                // Check if $selCourse is defined before using it
                                if (isset($selCourse)) {
                            ...
                            <?php
                                    ...
                                    echo '<tr><td colspan="2"><h3 class="p-3">Please define $selCourse</h3></td></tr>';
                                }
                            ?>
                        </tbody>
                    </table>
