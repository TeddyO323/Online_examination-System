...
<body>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $phone_number = isset($_POST['phone_number']) ? mysqli_real_escape_string($_POST['phone_number']) : 'Not provided';
            $address = isset($_POST['address']) ? mysqli_real_escape_string($_POST['address']) : 'Not provided';
