...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="assets/images/Minimalist Geometric Technology Computer Logo.png" alt="">
        <div class="text">
...
<script>
  ...
  setInterval(changeMessage, 3000);
      ...
      <div class="back">
        <img class="backImg" src="assets/images/Minimalist Geometric Technology Computer Logo.png" alt="">
        <div class="text">
